...
def create_institution():
    ...
    if request.method == "POST" and form.validate_on_submit():
        ...
        flash(f"Instituição {institution_data.get('name')!r} criada com sucesso", "success")
        return redirect(url_for("institution.get_institution", institution_id=institution.id))
...
def get_institution(institution_id: int):
    return f"Em construção {institution_id}"
